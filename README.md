# 👋 Hola, soy ShinobiDev79

### 🎓 Estudiante de Desarrollo Multiplataforma | 🔒 Entusiasta de la Ciberseguridad

Bienvenido a mi espacio de aprendizaje. Soy un desarrollador en formación enfocado en la intersección entre **crear software** y **asegurarlo**. Este perfil es un registro público de mi crecimiento técnico y experimentos.

> "La seguridad comienza con el anonimato y la privacidad. Aquí comparto mi journey técnico."

---

### 🚀 Sobre mí

- 🌱 **Actualmente:** Estudiando Desarrollo de Aplicaciones Multiplataforma y fundamentos de ciberseguridad.
- 🔭 **Objetivo:** Convertirme en un desarrollador especializado en *Secure Coding* y privacidad.
- 🛡️ **Intereses:** Seguridad en aplicaciones móviles, análisis de vulnerabilidades y Linux.
- 💡 **Enfoque:** Aprendizaje continuo mediante laboratorios privados, CTFs y documentación técnica.
- 📫 **Contacto:** Envíame un mensaje directo en GitHub o abre un **Issue** en este repositorio.
...
**En aprendizaje:**
[![Curso Kali](https://img.shields.io/badge/Curso_Kali-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/playlist?list=PLg7ZNf8WsbWAeoCT0j4HtptN3-v9KLILN)
...
| Área | Enfoque |
| :--- | :--- |
| **Desarrollo Móvil** | Apps nativas Android y soluciones multiplataforma. |
| **Seguridad Ofensiva** | Retos de TryHackMe y máquinas de HackTheBox (nivel fácil/medio). |
| **Seguridad Defensiva** | Implementación de prácticas seguras en código y configuración de servidores. |
| **Privacidad** | Herramientas de anonimato, navegación segura y hardening de OS. |
